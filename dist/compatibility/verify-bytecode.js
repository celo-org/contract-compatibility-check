...
// } from "./bytecode"
// import { verifyProxyStorageProof } from "./proxy-utils"
...
// const ignoredContracts = new Set([
...
//   const contract: string = queue.pop()!
...
//   const compiledContracts = new Set(artifacts.listArtifacts().map(a => a.contractName))
//   const queue = contracts.filter(
//     contract => !ignoredContracts.has(contract) && compiledContracts.has(contract),
//   )
