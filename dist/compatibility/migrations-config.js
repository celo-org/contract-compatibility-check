...
exports.linkedLibraries = void 0;
...
const DefaultConfig = {
    attestations: {
        attestationExpiryBlocks: HOUR / 5,
    ...
    exchange: {
        ...
        minimumReports: 1,
        frozen: false,
        minSupplyForStableBucketCap: "1000000000000000000000000",
    ...
    grandaMento: {
        ...
        maxApprovalExchangeRateChange: 0.3,
        spread: 0,
        vetoPeriodSeconds: 10,
        stableTokenExchangeLimits: {
            StableToken: {
                min: "50000000000000000000000",
    ...
    reserve: {
        tobinTaxStalenessThreshold: 100 * YEAR,
        tobinTax: toFixed(0).toFixed(0),
        tobinTaxReserveRatio: toFixed(0).toFixed(0),
        dailySpendingRatio: toFixed(0.05).toFixed(0),
    ...
    validators: {
        ...
        groupName: "cLabs",
        commission: 0.1,
        votesRatioOfLastVsFirstGroup: 2,
    },
    stableTokenRegistry: {
        fiatTicker: [],
...
const NetworkConfigs = {
    ...
    baklava: {
        ...
        governanceApproverMultiSig: {
            // 1/5 multsig
            signatories: [
                "0xb04778c00A8e30F59bFc91DD74853C4f32F34E54",
        ...
        reserve: {
            initialBalance: 100000000,
            frozenAssetsStartBalance: 80000000,
            frozenAssetsDays: 182, // 3x Mainnet thawing rate
        },
        reserveSpenderMultiSig: {
            // 1/3 multsig
            signatories: [
                "0x62C6a0446BbD7f6260108dD538d88E8b53128a90",
        ...
        validators: {
            ...
            membershipHistoryLength: 15,
            votesRatioOfLastVsFirstGroup: 1,
        },
    },
    alfajores: {
        downtimeSlasher: {
    ...
    rc1: {
        ...
        governance: {
            queueExpiry: 4 * WEEK,
            dequeueFrequency: DAY,
            concurrentProposals: 3,
            approvalStageDuration: DAY,
            referendumStageDuration: 2 * DAY,
            executionStageDuration: 3 * DAY,
            minDeposit: 100,
            participationBaseline: 5 / 100,
        ...
        transferWhitelist: {
            ...
            registryIds: [
                web3.utils.soliditySha3(registry_utils_1.CeloContractName.Governance),
                web3.utils.soliditySha3(registry_utils_1.CeloContractName.LockedGold),
                web3.utils.soliditySha3(registry_utils_1.CeloContractName.Reserve),
            ],
        },
    },
};
...
module.exports = {
    ...
    config,
    linkedLibraries: exports.linkedLibraries,
};
